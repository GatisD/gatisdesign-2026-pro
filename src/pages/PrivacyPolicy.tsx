...
const COPY = {
 ...
 {
 h: "Kādus datus apkopoju",
 p: "Kontaktformā apkopoju vārdu, e-pastu, uzņēmuma nosaukumu (ja norādīts) un ziņojuma saturu. Apkopoju tikai tos datus, ko jūs paši brīvprātīgi sniedzat.",
 },
 {
 h: "Kāpēc apkopoju",
 p: "Datus apkopoju, lai sazinātos ar jums un atbildētu uz jūsu pieprasījumu. Datus neizmantoju mārketinga saziņai bez atsevišķas piekrišanas.",
 },
 {
 h: "Cik ilgi glabāju",
 p: "Saziņas datus glabāju 24 mēnešus no pēdējās korespondences. Pēc tam dati tiek dzēsti.",
 },
 {
 h: "Analītika",
