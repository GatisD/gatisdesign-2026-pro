...
const COPY = {
 ...
 {
 title: "Kā strādāju",
 body: "Pirms zīmējuma jautāju par biznesu. Kas ir mērķauditorija. Kāpēc cilvēks šobrīd kaut ko nepērk. Kur ir pretestība. Dizains tikai pēc tam, kad atbildes ir uz papīra. Tas paņem vairāk laika, bet rezultāts vienmēr ir konkrētāks.",
 },
 {
 title: "Tehnoloģiju steks",
