...
export const dict = {
 ...
 sections: {
 featured: "Izlases darbi",
 featuredSub: "Trīs zīmolu identitātes ar pilnu sistēmu un viens logo apkopojums",
 clients: "Cilvēki, ar kuriem strādāju",
 clientsSub: "Klienti Latvijā, Lietuvā, Igaunijā un ASV",
 services: "Ar ko varu palīdzēt",
 cta: "Vai sākam darbu?",
 ctaSub:
 "Pirmā saruna ir bez maksas. Izpētu biznesu, saprotu uzdevumu, atbildu uz jautājumiem un dodu tāmi.",
 },
 services: {
 branding: {
 ...
 name: "Vārds",
 email: "E-pasts",
 company: "Uzņēmums (pēc izvēles)",
 message: "Par ko ir runa?",
