...
export const PORTFOLIO: PortfolioCollection[] = [
 ...
 description:
 "Box Latvia ir Latvijas iepakojuma risinājumu uzņēmums. Es izstrādāju zīmola identitāti, kas saglabā loģistikas nozarei nepieciešamo nopietnību, vienlaikus paliekot mūsdienīga un atpazīstama. Sistēma aptver logo, krāsu paleti, tipogrāfiju un iepakojuma marķējumus.",
